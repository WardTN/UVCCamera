...
import com.wardtn.uvccamera.encode.AACEncodeProcessor
import com.wardtn.uvccamera.encode.AbstractProcessor
import com.wardtn.uvccamera.encode.H264EncodeProcessor
import com.wardtn.uvccamera.render.env.RotateType
import com.wardtn.uvccamera.render.RenderManager
import com.wardtn.uvccamera.encode.audio.AudioStrategySystem
import com.wardtn.uvccamera.callback.*
import com.wardtn.uvccamera.camera.bean.CameraRequest
import com.wardtn.uvccamera.camera.bean.PreviewSize
import com.wardtn.uvccamera.encode.audio.AudioStrategyUAC
...
import com.wardtn.uvccamera.usb.DeviceFilter
import com.wardtn.uvccamera.usb.USBMonitor
import com.wardtn.uvccamera.utils.*
import com.wardtn.uvccamera.utils.CameraUtils.isFilterDevice
import com.wardtn.uvccamera.utils.CameraUtils.isUsbCamera
import com.wardtn.uvccamera.utils.Utils.debugCamera
...
class MultiCameraClient(ctx: Context, callback: IDeviceConnectCallBack?) {
            ...
            when (msg.what) {
                MSG_START_PREVIEW -> {
                    ...
                    when (val cameraView = mCameraView) {
                        ...
                        mRenderManager?.startRenderScreen(screenWidth,
                            screenHeight,
                            surface,
                ...
                MSG_CAPTURE_VIDEO_START -> {
                    (msg.obj as Triple<*, *, *>).apply {
                        captureVideoStartInternal(first as? String,
                            second as Long,
    ...
    companion object {
        ...
        private const val MSG_START_PREVIEW = 0x01 //开始预览
