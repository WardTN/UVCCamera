 ...
 * 在非root Android设备上访问UVC网络摄像头的库和示例
 *
...
#if 1	// 不发出调试信息时
	#ifndef LOG_NDEBUG
		#define	LOG_NDEBUG		// LOGV/LOGD/MARK 不输出时
		#endif
...
static ID_TYPE nativeCreate(JNIEnv *env, jobject thiz) {
	...
	ENTER();
	//创建一个 新的 UVCCamera 并将其指针赋值给 camera
	UVCCamera *camera = new UVCCamera();
	//将 UVCCamera 对象的指针(camera) 转换为 ID_TYPE 类型 并将其存储到 thiz（即 Java 对象）的 mNativePtr 字段中。
...
static JNINativeMethod methods[] = {
	...
	{ "nativeSetStatusCallback",		"(JLcom/wardtn/uvccamera/uvc/IStatusCallback;)I", (void *) nativeSetStatusCallback },
	{ "nativeSetButtonCallback",		"(JLcom/wardtn/uvccamera/uvc/IButtonCallback;)I", (void *) nativeSetButtonCallback },
	...
	{ "nativeSetFrameCallback",			"(JLcom/wardtn/uvccamera/uvc/IFrameCallback;I)I", (void *) nativeSetFrameCallback },
...
int register_uvccamera(JNIEnv *env) {
	...
	if (registerNativeMethods(env,
		"com/wardtn/uvccamera/uvc/UVCCamera",
